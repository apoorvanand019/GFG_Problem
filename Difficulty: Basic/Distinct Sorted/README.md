<h2><a href="https://www.geeksforgeeks.org/problems/distinct-sorted--124713/1?page=1&category=Java&sortBy=accuracy">Distinct Sorted</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an integer <strong>arr[]</strong>. You need to return an arraylist the<strong> distinct elements of arr in sorted order</strong>(non-decreasing).</span></p>
