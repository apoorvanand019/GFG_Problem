<h2><a href="https://www.geeksforgeeks.org/problems/fill-method/1?page=1&category=Java&sortBy=accuracy">Fill Method</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an integer array <strong>arr[]</strong>, you are also given a value k. You need to fill arr with k.</span></p>
